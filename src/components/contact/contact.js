...
export default function contact() {
  return (
    <section class="min-h-screen bg-gradient-to-r from-violet-600 via-violet-800 to-violet-900 dark:from-gray-700 dark:via-gray-800 dark:to-gray-900 ">
            ...
            <div class="mt-8 lg:w-1/2 lg:mx-6">
                <div class="w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl dark:bg-gray-900 lg:max-w-xl">
                    ...
                    <form class="mt-4">
                        ...
                        <button class="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-violet-600  hover:bg-violet-500 focus:outline-none focus:ring focus:ring-blue-400 focus:ring-opacity-50">
                            get in touch
                        </button>
                    </form>
                </div>
