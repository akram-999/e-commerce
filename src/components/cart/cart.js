            ...
            <div class="grid md:grid-cols-3 gap-4">
                ...
                <div class="bg-gray-100 rounded-md p-4 md:sticky top-0">
                    <div class="flex border border-blue-600 overflow-hidden rounded-md">
                        ...
                        <button type='button' class="flex items-center justify-center font-semibold tracking-wide bg-violet-600 hover:bg-violet-700 px-4 text-sm text-white">
                            Apply
                        </button>
                    </div>
                    ...
                    <div class="mt-8 space-y-2">
                        <button type="button" class="text-sm px-4 py-2.5 w-full font-semibold tracking-wide bg-violet-600 hover:bg-violet-700 text-white ">Checkout</button>
                        <button type="button" class="text-sm px-4 py-2.5 w-full font-semibold tracking-wide bg-transparent text-gray-800 border border-gray-300 ">Continue Shopping  </button>
                    </div>
                </div>
            </div>
        </div>
