      ...
      <div class="min-h-screen flex fle-col items-center justify-center lg:p-6 p-4">
        <div class="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
          <div>
            ...
            <p class="text-sm mt-6 text-white">Immerse yourself in a hassle-free register journey with our intuitively designed register form. Effortlessly access your account.</p>
            <p class="text-sm mt-6 text-white">Already have an account
                 <Link to="/login" class="text-white font-semibold underline ml-1">Login here</Link></p>
          </div>
